namespace MQtoUnity {
	...
	public class VoxelMesh {
		...
		private VoxelData MainVoxelData;
		...
		public void CreateVoxelMesh (VoxelData voxelData, float scale, Vector3 pivot, ref Mesh[] meshs, ref Texture2D texture) {
		...
		public void CreateVoxelMesh (VoxelData voxelData, float scale, Vector3 pivot, ref Texture2D texture, ref string objFile) {
		...
		private void InitVoxels (VoxelData voxelData, float scale, Vector3 pivot) {
			Scale = scale;
			Pivot = pivot;
		...
		private void CreateMesh (VoxelData voxelData, ref Mesh[] meshs, ref Texture2D aimTexture) {
